...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(102060348455115098)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(97546693901936084)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(97590021532319094)
,p_plug_name=>'Summary Detail'
,p_parent_plug_id=>wwv_flow_api.id(97546693901936084)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(108763393831158784)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(108763305418158783)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(98986399407378598)
,p_name=>'THV_FORMULA2'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(98986235520378597)
,p_name=>'THV_FORMULA1'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(97590355236319097)
,p_name=>'HEA_TEXT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(97590272746319096)
,p_name=>'SEQ_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(76663307710118816)
,p_name=>'TPH_THG_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_interactive_grid(
 p_id=>wwv_flow_api.id(97590132459319095)
...
wwv_flow_api.create_ig_report(
 p_id=>wwv_flow_api.id(97610830570472307)
,p_interactive_grid_id=>wwv_flow_api.id(97590132459319095)
,p_static_id=>'278907'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
...
wwv_flow_api.create_ig_report_view(
 p_id=>wwv_flow_api.id(97610953201472307)
,p_report_id=>wwv_flow_api.id(97610830570472307)
,p_view_type=>'GRID'
...
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(108803119788241599)
,p_view_id=>wwv_flow_api.id(97610953201472307)
,p_display_seq=>4
,p_column_id=>wwv_flow_api.id(108763393831158784)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(108802152017241597)
,p_view_id=>wwv_flow_api.id(97610953201472307)
,p_display_seq=>3
,p_column_id=>wwv_flow_api.id(108763305418158783)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(99010014108443897)
,p_view_id=>wwv_flow_api.id(97610953201472307)
,p_display_seq=>6
,p_column_id=>wwv_flow_api.id(98986399407378598)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(99009123827443895)
,p_view_id=>wwv_flow_api.id(97610953201472307)
,p_display_seq=>5
,p_column_id=>wwv_flow_api.id(98986235520378597)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(97611978023472319)
,p_view_id=>wwv_flow_api.id(97610953201472307)
,p_display_seq=>1
,p_column_id=>wwv_flow_api.id(97590355236319097)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(97611426146472313)
,p_view_id=>wwv_flow_api.id(97610953201472307)
,p_display_seq=>0
,p_column_id=>wwv_flow_api.id(97590272746319096)
,p_is_visible=>true
,p_is_frozen=>false
,p_sort_order=>1
...
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(76612184424031724)
,p_view_id=>wwv_flow_api.id(97610953201472307)
,p_display_seq=>2
,p_column_id=>wwv_flow_api.id(76663307710118816)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(76663223128118815)
,p_name=>'Summary'
,p_parent_plug_id=>wwv_flow_api.id(97546693901936084)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(254020007719463958)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(254019650020463958)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(254019194773463958)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(254020418633463964)
,p_query_column_id=>4
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(254022192199464005)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(97546693901936084)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(254021764872463999)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(254021437482463999)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(254012981203463930)
,p_branch_name=>'GoTo30'
,p_branch_action=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(254021764872463999)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(254013426343463933)
,p_branch_name=>'Show preview'
,p_branch_action=>'P85_DOWNLOAD_URL'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'BRANCH_TO_URL_IDENT_BY_ITEM'
,p_branch_when_button_id=>wwv_flow_api.id(254022192199464005)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(254020999651463997)
,p_name=>'P85_DOWNLOAD_URL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(97546693901936084)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(254014327353463933)
...
,p_process_when_button_id=>wwv_flow_api.id(254021764872463999)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(254014747032463938)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(254022192199464005)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(254013872829463933)
,p_process_sequence=>10
