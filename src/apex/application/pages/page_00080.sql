...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(89387726419965457)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(85225836831720232)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(254116048683264089)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(85225836831720232)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(254110342120263905)
,p_branch_name=>'GoTo Page 81'
,p_branch_action=>'f?p=&APP_ID.:81:&SESSION.::&DEBUG.:81::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(254116048683264089)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(254115319089264053)
,p_name=>'P80_NAME'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(85225836831720232)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(254114930507264044)
,p_name=>'P80_DEADLINE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(85225836831720232)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(254114550630264044)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(254114083462264042)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(254145911547853149)
,p_name=>'Change'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(254145611707853146)
,p_event_id=>wwv_flow_api.id(254145911547853149)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(254145463247853145)
,p_event_id=>wwv_flow_api.id(254145911547853149)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(254145798433853148)
,p_event_id=>wwv_flow_api.id(254145911547853149)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(254145754131853147)
,p_event_id=>wwv_flow_api.id(254145911547853149)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(254113086645263933)
...
,p_process_when_button_id=>wwv_flow_api.id(254116048683264089)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(254112726910263928)
,p_process_sequence=>10
