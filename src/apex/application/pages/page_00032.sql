...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(71436808541676317)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(96800056054149142)
,p_button_name=>'Save'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(71436695559676316)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71423198579358742)
,p_name=>'P32_ENABLED'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(96800056054149142)
,p_prompt=>'Status'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71422819588358740)
,p_name=>'P32_DAYS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(96800056054149142)
,p_prompt=>'Days'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(71436621579676315)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(71436695559676316)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(71436494438676314)
,p_event_id=>wwv_flow_api.id(71436621579676315)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71437163833676321)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71436922567676318)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71436365044676313)
,p_process_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71436256860676311)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
