...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15565268197976003)
,p_plug_name=>'Filter'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15565393218976004)
,p_name=>'P0_TEMPLATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(15565268197976003)
,p_prompt=>'Template'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15565020383976001)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15565134812976002)
,p_event_id=>wwv_flow_api.id(15565020383976001)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15565483910976005)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15565599523976006)
,p_event_id=>wwv_flow_api.id(15565483910976005)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
