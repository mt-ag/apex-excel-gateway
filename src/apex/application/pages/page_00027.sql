...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(130692608513018776)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(130689834882017423)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(132312786826723980)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(130689834882017423)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(132313174935723980)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(132310922607723978)
,p_name=>'P27_DROPDOWN_VALUES'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(130692608513018776)
,p_prompt=>'Add Dropdown Values (Optioal)'
,p_display_as=>'PLUGIN_MESQUITAROD.MULTIROW.ITEM'
,p_cSize=>90
,p_field_template=>wwv_flow_api.id(118273763341341882)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(132310487039723977)
,p_name=>'P27_HEA_VAL_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(130692608513018776)
,p_item_source_plug_id=>wwv_flow_api.id(130692608513018776)
,p_prompt=>'Validation'
,p_source=>'HEA_VAL_ID'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(132310124622723976)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(132309739678723976)
,p_name=>'P27_HEA_TEXT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(132309268851723976)
,p_name=>'P27_HEA_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(132314415872723982)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(132312786826723980)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(132314911481723983)
,p_event_id=>wwv_flow_api.id(132314415872723982)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(132315284552723983)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(132313586287723982)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(132313987866723982)
