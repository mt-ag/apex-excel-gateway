...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(89268019405847556)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(85106129817602331)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(85106379305602333)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(85106129817602331)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(85148504276985331)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(89268141525847557)
,p_branch_name=>'GoTo Page 21'
,p_branch_action=>'f?p=&APP_ID.:21:&SESSION.::&DEBUG.:21::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(85106379305602333)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(97720739058310832)
,p_name=>'P20_NUMBER_OF_ROWS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(85106129817602331)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(97720642223310831)
,p_name=>'P20_DEADLINE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(85106129817602331)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(85106227629602332)
,p_name=>'P20_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(85106129817602331)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(89268227671847558)
,p_validation_name=>'Check Template Name'
,p_validation_sequence=>10
,p_validation=>'P20_NAME'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Please enter a template Name'
,p_when_button_pressed=>wwv_flow_api.id(85106379305602333)
,p_associated_item=>wwv_flow_api.id(85106227629602332)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(85148641542985332)
,p_name=>'Clear all items'
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(85148504276985331)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(85148742352985333)
,p_event_id=>wwv_flow_api.id(85148641542985332)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(85148840953985334)
,p_event_id=>wwv_flow_api.id(85148641542985332)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(85150845772985354)
,p_event_id=>wwv_flow_api.id(85148641542985332)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(89267866313847554)
...
,p_process_when_button_id=>wwv_flow_api.id(85106379305602333)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(79386473856742246)
,p_process_sequence=>10
