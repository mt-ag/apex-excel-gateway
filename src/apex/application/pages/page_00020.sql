...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17580883520914386)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(13418993932669161)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17580634032914384)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(17580883520914386)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17538509061531386)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(13418871812669160)
,p_branch_name=>'GoTo Page 21'
,p_branch_action=>'f?p=&APP_ID.:21:&SESSION.::&DEBUG.:21::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(17580634032914384)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17580785708914385)
,p_name=>'P20_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(17580883520914386)
,p_prompt=>'Template Name'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_field_template=>wwv_flow_api.id(18685817563288672)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4966371115205886)
,p_name=>'P20_DEADLINE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(17580883520914386)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(4966274280205885)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(13418785666669159)
,p_validation_name=>'Check Template Name'
,p_validation_sequence=>10
,p_validation=>'P20_NAME'
,p_validation_type=>'ITEM_NOT_NULL'
,p_error_message=>'Please enter a template Name'
,p_when_button_pressed=>wwv_flow_api.id(17580634032914384)
,p_associated_item=>wwv_flow_api.id(17580785708914385)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(17538371795531385)
,p_name=>'Clear all items'
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(17538509061531386)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(17538270985531384)
,p_event_id=>wwv_flow_api.id(17538371795531385)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(17538172384531383)
,p_event_id=>wwv_flow_api.id(17538371795531385)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(17536167565531363)
,p_event_id=>wwv_flow_api.id(17538371795531385)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(13419147024669163)
...
,p_process_when_button_id=>wwv_flow_api.id(17580634032914384)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23300539481774471)
,p_process_sequence=>10
