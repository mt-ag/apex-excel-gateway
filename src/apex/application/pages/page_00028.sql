...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(66938482188571578)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(66935708557570225)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(98032829360606966)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(66935708557570225)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(98033262268606970)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(98030927566606963)
,p_name=>'P28_THG_XLSX_FONT_COLOR'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(66938482188571578)
,p_item_source_plug_id=>wwv_flow_api.id(66938482188571578)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(98030587629606962)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(98030164535606962)
,p_name=>'P28_THG_TEXT'
,p_source_data_type=>'VARCHAR2'
,p_is_required=>true
,p_item_sequence=>20
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(98029783994606959)
,p_name=>'P28_THG_ID'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(98034491026606996)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(98032829360606966)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(98034900168606998)
,p_event_id=>wwv_flow_api.id(98034491026606996)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(98033612563606994)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(98034063368606995)
