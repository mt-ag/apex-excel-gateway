...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(178964252952173468)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(349011046483091273)
,p_plug_template_id=>wwv_flow_api.id(178964252952173468)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(349010957117091273)
,p_plug_template_id=>wwv_flow_api.id(178964252952173468)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(349010851328091273)
,p_plug_template_id=>wwv_flow_api.id(178964252952173468)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(349010712076091273)
,p_plug_template_id=>wwv_flow_api.id(178964252952173468)
,p_name=>'Previous'
