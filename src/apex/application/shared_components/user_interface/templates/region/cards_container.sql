...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(173609356582709370)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(349015114274091275)
,p_plug_template_id=>wwv_flow_api.id(173609356582709370)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(349014978281091275)
,p_plug_template_id=>wwv_flow_api.id(173609356582709370)
,p_name=>'Sub Regions'
