...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(178956560823173463)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(349012663273091274)
,p_plug_template_id=>wwv_flow_api.id(178956560823173463)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(349012591247091274)
,p_plug_template_id=>wwv_flow_api.id(178956560823173463)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(349012497390091274)
,p_plug_template_id=>wwv_flow_api.id(178956560823173463)
,p_name=>'Next'
,p_placeholder=>'NEXT'
