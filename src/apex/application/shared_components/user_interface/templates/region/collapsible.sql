...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87246347614596370)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(167741902622302822)
,p_plug_template_id=>wwv_flow_api.id(87246347614596370)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(167741372244302822)
,p_plug_template_id=>wwv_flow_api.id(87246347614596370)
,p_name=>'Sub Regions'
