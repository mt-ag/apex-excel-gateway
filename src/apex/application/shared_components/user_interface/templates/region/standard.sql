...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(118212914933341838)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(37755020136635446)
,p_plug_template_id=>wwv_flow_api.id(118212914933341838)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(37754534372635446)
,p_plug_template_id=>wwv_flow_api.id(118212914933341838)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
