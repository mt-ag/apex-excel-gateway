...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(170057084184918290)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(250515464745624682)
,p_plug_template_id=>wwv_flow_api.id(170057084184918290)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(250514978981624682)
,p_plug_template_id=>wwv_flow_api.id(170057084184918290)
,p_name=>'Sub Regions'
