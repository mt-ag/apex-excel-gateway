...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(170081328482918306)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(250585881008624777)
,p_plug_template_id=>wwv_flow_api.id(170081328482918306)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(250585314809624777)
,p_plug_template_id=>wwv_flow_api.id(170081328482918306)
,p_name=>'Slides'
