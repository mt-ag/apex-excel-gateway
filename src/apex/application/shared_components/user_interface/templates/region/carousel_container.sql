...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(118188670635341822)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(37684684308635351)
,p_plug_template_id=>wwv_flow_api.id(118188670635341822)
,p_name=>'Slides'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(37684118109635351)
,p_plug_template_id=>wwv_flow_api.id(118188670635341822)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
