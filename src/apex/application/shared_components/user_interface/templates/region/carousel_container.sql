...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(87253547537596375)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(167758100063302846)
,p_plug_template_id=>wwv_flow_api.id(87253547537596375)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(167757533864302846)
,p_plug_template_id=>wwv_flow_api.id(87253547537596375)
,p_name=>'Slides'
