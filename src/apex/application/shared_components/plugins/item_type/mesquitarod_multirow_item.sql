...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(168906334576373127)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(168904934270349478)
,p_plugin_id=>wwv_flow_api.id(168906334576373127)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(168904712169339943)
,p_plugin_id=>wwv_flow_api.id(168906334576373127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(168904374254334810)
,p_plugin_id=>wwv_flow_api.id(168906334576373127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(168904043037329292)
,p_plugin_id=>wwv_flow_api.id(168906334576373127)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(168905320805360667)
,p_plugin_id=>wwv_flow_api.id(168906334576373127)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(168893391602773774)
,p_plugin_id=>wwv_flow_api.id(168906334576373127)
