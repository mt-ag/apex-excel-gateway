...
ACCEPT ws_name char default 'APEX-EXCEL-GATEWAY' PROMPT 'Enter Workspace Name: [APEX-EXCEL-GATEWAY]'
ACCEPT parsing_schema char default 'APEX_EXCEL_GATEWAY' PROMPT 'Enter Parsing Schema: [APEX_EXCEL_GATEWAY]'
ACCEPT app_alias char default 'APEX_EXCEL_GATEWAY' PROMPT 'Enter Application Alias: [APEX_EXCEL_GATEWAY]'
